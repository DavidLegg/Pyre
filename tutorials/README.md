...
I suggest that everyone read [Intro to Modeling][], as this introduces key concepts for all Pyre projects.
...
- For those writing schedulers or planners on top of the simulation, I suggest [Scheduling][].
  This section explores how to use Pyre's scheduling support to build plans programmatically, informed by simulation.
  This includes an exploration of Pyre's incremental simulation capabilities, and a discussion of the capabilities, limitations, and additional model requirements that come with it.
