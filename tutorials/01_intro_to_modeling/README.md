...
Additionally, each lesson includes the finished code for that lesson, ready to be executed.
You can run the code for a lesson using `./gradlew :tutorials:01_intro_to_modeling:<lesson directory>:run` from the repository root.
