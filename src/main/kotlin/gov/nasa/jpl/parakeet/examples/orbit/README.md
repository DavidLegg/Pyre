...
As an example to learn from, this model demonstrates a few features of Parakeet, like the use of daemon tasks, resources, unit-awareness, and how to efficiently direct output to file.
