package gov.nasa.jpl.parakeet.examples.scheduling.gnc.model
...
import gov.nasa.jpl.parakeet.general.resources.caching.ResourceCaching.cached
import gov.nasa.jpl.parakeet.general.units.quantity_resource.MutableQuantityResource
...
import gov.nasa.jpl.parakeet.general.units.StandardUnits.MINUTE
...
import gov.nasa.jpl.parakeet.foundation.resources.discrete.BooleanResourceOperations.choose
...
import gov.nasa.jpl.parakeet.foundation.resources.discrete.DiscreteResourceMonad.bind
...
import gov.nasa.jpl.parakeet.general.units.discrete_unit_aware_resource.UnitAwareDiscreteResourceOperations.VsScalar.lessThanOrEquals
import gov.nasa.jpl.parakeet.general.units.discrete_unit_aware_resource.UnitAwareDiscreteResourceOperations.discreteResource
