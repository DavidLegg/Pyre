...
Foundation is the principal "ergonomics" layer of Parakeet, building on top of kernel.
It's meant to contain functionality which is essential to the real-world use of Parakeet.
...
1. Can an equivalent simulation be written without this feature, even if doing so would be painful?
    - If not, this feature changes the fundamental capability of Parakeet, and belongs in kernel instead.
2. Are most modelers using Parakeet expected to use this feature?
