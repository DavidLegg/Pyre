...
class IncrementalSimulatorTest {
    ...
    @Test
    fun `repro directly`() {
        var tester = test(GroundedActivity(Instant.parse("2025-01-01T12:32:11.857785Z"), Name("708226302789"), SpawnChildren(id = "SC-5721")))
        println("Running round 4 of edits...")
        tester.add(GroundedActivity(Instant.parse("2025-01-01T06:02:01.532494Z"), Name("205374469420"), SpawnChildPair(child1 = SpawnChild(child = ReportStandaloneCounter(id = "2892")), child2 = SetStandaloneCounter(number = 46))))
        println("Running round 8 of edits...")
        val inconTime = Instant.parse("2025-01-01T02:10:49.321948Z")
        val incon = tester.save(inconTime)
        tester = test(startTime = inconTime, endTime = inconTime + 1.days, incon = incon)
        println("Running round 33 of edits...")
        tester.add(GroundedActivity(Instant.parse("2025-01-01T19:32:19.029098Z"), Name("134630666432"), SpawnChildPair(child1 = SpawnChild(child = SetIntegrand(number = -0.10674029024974785)), child2 = SpawnChild(child = AddJob(seed = 6)))))
        println("Running round 39 of edits...")
        tester.move(GroundedActivity(Instant.parse("2025-01-01T19:32:19.029098Z"), Name("134630666432"), SpawnChildPair(child1 = SpawnChild(child = SetIntegrand(number = -0.10674029024974785)), child2 = SpawnChild(child = AddJob(seed = 6)))) to Instant.parse("2025-01-01T19:26:24.134318Z"))
        println("Running round 41 of edits...")
        tester.add(GroundedActivity(Instant.parse("2025-01-01T08:02:06.431419Z"), Name("222982501217"), SpawnChildPair(child1 = SetDerivationSource(number = -5), child2 = SpawnChildren(id = "SC-9505"))))
        println("Running round 43 of edits...")
        tester.edit(GroundedActivity(Instant.parse("2025-01-01T19:26:24.134318Z"), Name("134630666432"), SpawnChildPair(child1 = SpawnChild(child = SetIntegrand(number = -0.10674029024974785)), child2 = SpawnChild(child = AddJob(seed = 6)))) to SpawnChildPair(child1 = SetIntegrand(number = -0.35070814850239795), child2 = SpawnChildPair(child1 = AddJob(seed = 25), child2 = SpawnChildPair(child1 = SetIntegrand(number = 0.560338146422311), child2 = SpawnChildPair(child1 = SetIntegrand(number = 0.9639974445088031), child2 = SetStandaloneCounter(number = 28))))))
        println("Running round 45 of edits...")
        tester.move(GroundedActivity(Instant.parse("2025-01-01T19:26:24.134318Z"), Name("134630666432"), SpawnChildPair(child1 = SetIntegrand(number = -0.35070814850239795), child2 = SpawnChildPair(child1 = AddJob(seed = 25), child2 = SpawnChildPair(child1 = SetIntegrand(number = 0.560338146422311), child2 = SpawnChildPair(child1 = SetIntegrand(number = 0.9639974445088031), child2 = SetStandaloneCounter(number = 28)))))) to Instant.parse("2025-01-01T19:18:42.388485Z"))
        println("Running round 50 of edits...")
        tester.move(GroundedActivity(Instant.parse("2025-01-01T19:18:42.388485Z"), Name("134630666432"), SpawnChildPair(child1 = SetIntegrand(number = -0.35070814850239795), child2 = SpawnChildPair(child1 = AddJob(seed = 25), child2 = SpawnChildPair(child1 = SetIntegrand(number = 0.560338146422311), child2 = SpawnChildPair(child1 = SetIntegrand(number = 0.9639974445088031), child2 = SetStandaloneCounter(number = 28)))))) to Instant.parse("2025-01-01T19:20:44.453117Z"))
        println("Running round 52 of edits...")
        tester.move(GroundedActivity(Instant.parse("2025-01-01T19:20:44.453117Z"), Name("134630666432"), SpawnChildPair(child1 = SetIntegrand(number = -0.35070814850239795), child2 = SpawnChildPair(child1 = AddJob(seed = 25), child2 = SpawnChildPair(child1 = SetIntegrand(number = 0.560338146422311), child2 = SpawnChildPair(child1 = SetIntegrand(number = 0.9639974445088031), child2 = SetStandaloneCounter(number = 28)))))) to Instant.parse("2025-01-01T19:28:17.079597Z"))
        println("Running round 57 of edits...")
        tester.edit(GroundedActivity(Instant.parse("2025-01-01T19:28:17.079597Z"), Name("134630666432"), SpawnChildPair(child1 = SetIntegrand(number = -0.35070814850239795), child2 = SpawnChildPair(child1 = AddJob(seed = 25), child2 = SpawnChildPair(child1 = SetIntegrand(number = 0.560338146422311), child2 = SpawnChildPair(child1 = SetIntegrand(number = 0.9639974445088031), child2 = SetStandaloneCounter(number = 28)))))) to SpawnChildPair(child1 = SpawnChildPair(child1 = IncrementStandaloneCounter(number = 1), child2 = SetDerivationSource(number = 4)), child2 = SpawnChildPair(child1 = IncrementStandaloneCounter(number = -1), child2 = SetStandaloneCounter(number = -5))))
    }
