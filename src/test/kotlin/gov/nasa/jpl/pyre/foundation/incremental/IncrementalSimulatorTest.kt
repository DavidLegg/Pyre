...
class IncrementalSimulatorTest {
    ...
    fun `repro directly`() {
        val tester = test(::BlockTestModel,
            ...
            activities = listOf(
                GroundedActivity(Instant.parse("2025-01-01T21:51:34.499225Z"), Name("736597096622"), BlockActivity(statements=listOf(IncreaseSlope(index=ConstantInt(value=93), amount=ConstantDouble(value=-55.756097243918035))))),
                GroundedActivity(Instant.parse("2025-01-01T03:22:39.394454Z"), Name("337694448110"), BlockActivity(statements=listOf(SetCounter(index=SubtractInts(left=ReadCounter(indexExpression=ConstantInt(value=-42)), right=AddInts(left=IntFromDouble(doubleExpression=ReadSavedDouble), right=ConstantInt(value=29))), value=ConstantInt(value=43)), SetSlope(index=ReadCounter(indexExpression=SubtractInts(left=IntFromDouble(doubleExpression=ConstantDouble(value=35.620141405918986)), right=ReadSavedInt)), value=ConstantDouble(value=79.94810127999787))))),
                GroundedActivity(Instant.parse("2025-01-01T03:46:19.959262Z"), Name("761283130743"), BlockActivity(statements=listOf(SetCounter(index=ConstantInt(value=-90), value=AddInts(left=ConstantInt(value=54), right=AddInts(left=ConstantInt(value=62), right=ReadCounter(indexExpression=ConstantInt(value=-28))))), SetSlope(index=SubtractInts(left=AddInts(left=ConstantInt(value=-51), right=AddInts(left=ReadCounter(indexExpression=ReadCounter(indexExpression=ReadSavedInt)), right=SubtractInts(left=SubtractInts(left=ReadCounter(indexExpression=ConstantInt(value=77)), right=ConstantInt(value=13)), right=ConstantInt(value=69)))), right=ConstantInt(value=31)), value=ReadIntegral(indexExpression=ConstantInt(value=-42))), SetCounter(index=ConstantInt(value=4), value=ReadSavedInt)))),
                GroundedActivity(Instant.parse("2025-01-01T14:43:51.703869Z"), Name("105481160901"), BlockActivity(statements=listOf(SetSlope(index=IntFromDouble(doubleExpression=ConstantDouble(value=-87.53273782922437)), value=ConstantDouble(value=-49.62606475273563))))),
                GroundedActivity(Instant.parse("2025-01-01T13:42:59.340302Z"), Name("863902920796"), BlockActivity(statements=listOf(Spawn(body=listOf(IncreaseSlope(index=SubtractInts(left=ConstantInt(value=2), right=ConstantInt(value=63)), amount=ConstantDouble(value=-19.94758877257412)), Spawn(body=listOf(SetSlope(index=ConstantInt(value=-45), value=ConstantDouble(value=-28.79132797896962)), IncreaseSlope(index=ReadCounter(indexExpression=ReadSavedInt), amount=ConstantDouble(value=30.914116335875406))))))))),
                GroundedActivity(Instant.parse("2025-01-01T14:01:59.002625Z"), Name("350619352433"), BlockActivity(statements=listOf(IncrementCounter(index=ReadCounter(indexExpression=ReadCounter(indexExpression=ConstantInt(value=30))), amount=ConstantInt(value=47)), IncrementCounter(index=SubtractInts(left=ConstantInt(value=73), right=IntFromDouble(doubleExpression=ConstantDouble(value=-88.88173814250271))), amount=ConstantInt(value=-61))))),
                GroundedActivity(Instant.parse("2025-01-01T13:12:43.286328Z"), Name("983811240805"), BlockActivity(statements=listOf(IncreaseSlope(index=AddInts(left=SubtractInts(left=ConstantInt(value=47), right=ConstantInt(value=-21)), right=ConstantInt(value=-53)), amount=ReadSlope(indexExpression=SubtractInts(left=SubtractInts(left=ConstantInt(value=-5), right=ConstantInt(value=61)), right=SubtractInts(left=ConstantInt(value=-35), right=ConstantInt(value=63)))))))),
                GroundedActivity(Instant.parse("2025-01-01T12:38:06.915533Z"), Name("594733413265"), BlockActivity(statements=listOf(IncreaseSlope(index=ConstantInt(value=7), amount=ConstantDouble(value=47.870391028308404))))),
                GroundedActivity(Instant.parse("2025-01-01T21:27:50.034961Z"), Name("840438594862"), BlockActivity(statements=listOf(SetSlope(index=AddInts(left=ConstantInt(value=-14), right=ConstantInt(value=83)), value=ReadIntegral(indexExpression=ConstantInt(value=10))), SetSlope(index=ReadCounter(indexExpression=AddInts(left=ConstantInt(value=77), right=AddInts(left=ConstantInt(value=68), right=ReadSavedInt))), value=ConstantDouble(value=7.384370402966979)), ToggleSwitch(index=ReadCounter(indexExpression=IntFromDouble(doubleExpression=ConstantDouble(value=-43.909437477647906))))))),
                GroundedActivity(Instant.parse("2025-01-01T15:06:19.471753Z"), Name("600760697614"), BlockActivity(statements=listOf(SetSlope(index=ConstantInt(value=-35), value=ConstantDouble(value=-32.12656695035592))))),
                GroundedActivity(Instant.parse("2025-01-01T10:43:56.765546Z"), Name("217238741894"), BlockActivity(statements=listOf(SetSlope(index=ConstantInt(value=58), value=DoubleFromInt(intExpression=IntFromDouble(doubleExpression=ConstantDouble(value=-63.02230361607175))))))),
                ...
                GroundedActivity(Instant.parse("2025-01-01T18:28:57.590723Z"), Name("325331891877"), BlockActivity(statements=listOf(Spawn(body=listOf(SetSlope(index=AddInts(left=ConstantInt(value=67), right=ConstantInt(value=21)), value=ConstantDouble(value=-67.75409102135536))))))),
                GroundedActivity(Instant.parse("2025-01-01T12:44:07.470244Z"), Name("820137411158"), BlockActivity(statements=listOf(SetCounter(index=AddInts(left=SubtractInts(left=ConstantInt(value=3), right=ReadSavedInt), right=ConstantInt(value=-69)), value=ConstantInt(value=26)), IncreaseSlope(index=ReadCounter(indexExpression=ConstantInt(value=27)), amount=ReadIntegral(indexExpression=ConstantInt(value=47)))))),
                GroundedActivity(Instant.parse("2025-01-01T17:15:28.759908Z"), Name("766905776195"), BlockActivity(statements=listOf(IncrementCounter(index=ConstantInt(value=31), amount=ReadCounter(indexExpression=ConstantInt(value=37)))))),
                GroundedActivity(Instant.parse("2025-01-01T13:52:24.341606Z"), Name("816424769310"), BlockActivity(statements=listOf(SetSlope(index=ConstantInt(value=-1), value=SubtractDoubles(left=ConstantDouble(value=-22.746053763374903), right=ConstantDouble(value=52.32903994897575)))))),
                GroundedActivity(Instant.parse("2025-01-01T18:40:04.003365Z"), Name("886404726215"), BlockActivity(statements=listOf(Spawn(body=listOf(Spawn(body=listOf(ToggleSwitch(index=ConstantInt(value=-1))))))))),
                GroundedActivity(Instant.parse("2025-01-01T19:48:25.438404Z"), Name("801426023514"), BlockActivity(statements=listOf(SetCounter(index=SubtractInts(left=ConstantInt(value=-1), right=ReadSavedInt), value=AddInts(left=ConstantInt(value=-87), right=ConstantInt(value=92))), SetSlope(index=ConstantInt(value=-47), value=ReadIntegral(indexExpression=AddInts(left=ConstantInt(value=-38), right=ReadCounter(indexExpression=IntFromDouble(doubleExpression=ConstantDouble(value=28.3032692731029))))))))),
                GroundedActivity(Instant.parse("2025-01-01T17:21:38.098034Z"), Name("141165874399"), BlockActivity(statements=listOf(SetSlope(index=SubtractInts(left=ConstantInt(value=62), right=ConstantInt(value=27)), value=ReadIntegral(indexExpression=ReadCounter(indexExpression=IntFromDouble(doubleExpression=AddDoubles(left=ConstantDouble(value=-76.75891592989248), right=ConstantDouble(value=60.22148837694553))))))))),
                GroundedActivity(Instant.parse("2025-01-01T13:21:05.200451Z"), Name("966355974596"), BlockActivity(statements=listOf(IncreaseSlope(index=ReadSavedInt, amount=DoubleFromInt(intExpression=AddInts(left=ConstantInt(value=-40), right=AddInts(left=ConstantInt(value=-37), right=ReadCounter(indexExpression=ConstantInt(value=-45))))))))),
                GroundedActivity(Instant.parse("2025-01-01T04:18:32.894284Z"), Name("518148181379"), BlockActivity(statements=listOf(SetSlope(index=AddInts(left=ReadCounter(indexExpression=ConstantInt(value=73)), right=ConstantInt(value=-52)), value=ConstantDouble(value=51.86552228797666))))),
                GroundedActivity(Instant.parse("2025-01-01T16:43:01.297355Z"), Name("475545821215"), BlockActivity(statements=listOf(ToggleSwitch(index=ConstantInt(value=5))))),
                GroundedActivity(Instant.parse("2025-01-01T23:55:49.563378Z"), Name("108319440099"), BlockActivity(statements=listOf(IncreaseSlope(index=SubtractInts(left=ConstantInt(value=10), right=ReadSavedInt), amount=ConstantDouble(value=87.03920181776857))))),
                GroundedActivity(Instant.parse("2025-01-01T05:24:28.743441Z"), Name("876200635547"), BlockActivity(statements=listOf(SetSlope(index=IntFromDouble(doubleExpression=ConstantDouble(value=-82.55608922276812)), value=ConstantDouble(value=-58.34782248215213))))),
                GroundedActivity(Instant.parse("2025-01-01T18:51:49.119817Z"), Name("250607896029"), BlockActivity(statements=listOf(IncrementCounter(index=ReadCounter(indexExpression=ConstantInt(value=-46)), amount=SubtractInts(left=IntFromDouble(doubleExpression=ConstantDouble(value=14.971737391456514)), right=ConstantInt(value=-41)))))),
                GroundedActivity(Instant.parse("2025-01-01T01:51:22.386473Z"), Name("703648583189"), BlockActivity(statements=listOf(SetSlope(index=SubtractInts(left=ConstantInt(value=29), right=ConstantInt(value=82)), value=ConstantDouble(value=-62.619493048319484))))),
                GroundedActivity(Instant.parse("2025-01-01T01:41:32.207700Z"), Name("896927724032"), BlockActivity(statements=listOf(SetCounter(index=ConstantInt(value=-19), value=ConstantInt(value=-82))))),
                GroundedActivity(Instant.parse("2025-01-01T03:58:37.617279Z"), Name("257493092100"), BlockActivity(statements=listOf(IncrementCounter(index=ConstantInt(value=-14), amount=ConstantInt(value=79)), SetSlope(index=ConstantInt(value=59), value=ReadSavedDouble)))),
                GroundedActivity(Instant.parse("2025-01-02T00:42:12.133Z"), Name("570730811939"), BlockActivity(statements=listOf(SetSlope(index=IntFromDouble(doubleExpression=DoubleFromInt(intExpression=ConstantInt(value=-90))), value=ReadIntegral(indexExpression=AddInts(left=ReadSavedInt, right=SubtractInts(left=SubtractInts(left=IntFromDouble(doubleExpression=ConstantDouble(value=71.88575701038471)), right=ConstantInt(value=-82)), right=SubtractInts(left=AddInts(left=AddInts(left=ReadCounter(indexExpression=ConstantInt(value=-1)), right=ConstantInt(value=47)), right=ConstantInt(value=20)), right=ConstantInt(value=94))))))))),
                GroundedActivity(Instant.parse("2025-01-01T13:58:35.680362Z"), Name("145337560229"), BlockActivity(statements=listOf(SetSlope(index=ConstantInt(value=39), value=ConstantDouble(value=11.699789363640846)), SetCounter(index=ReadCounter(indexExpression=SubtractInts(left=ConstantInt(value=-1), right=SubtractInts(left=ReadSavedInt, right=AddInts(left=ReadSavedInt, right=ConstantInt(value=44))))), value=AddInts(left=ConstantInt(value=-52), right=ConstantInt(value=36))), SetCounter(index=ReadSavedInt, value=ConstantInt(value=28))))),
                GroundedActivity(Instant.parse("2025-01-02T00:36:32.520170Z"), Name("247967945884"), BlockActivity(statements=listOf(SetSlope(index=ConstantInt(value=-50), value=DoubleFromInt(intExpression=ConstantInt(value=-97)))))),
                GroundedActivity(Instant.parse("2025-01-01T09:51:54.348529Z"), Name("336157954619"), BlockActivity(statements=listOf(IncreaseSlope(index=AddInts(left=ConstantInt(value=-56), right=ReadSavedInt), amount=ConstantDouble(value=68.34475225793034))))),
                GroundedActivity(Instant.parse("2025-01-02T04:24:02.230089Z"), Name("680193939163"), BlockActivity(statements=listOf(SetSlope(index=AddInts(left=SubtractInts(left=ReadCounter(indexExpression=AddInts(left=SubtractInts(left=ConstantInt(value=95), right=ConstantInt(value=25)), right=SubtractInts(left=ConstantInt(value=36), right=ReadCounter(indexExpression=ConstantInt(value=-18))))), right=ConstantInt(value=-91)), right=AddInts(left=IntFromDouble(doubleExpression=ConstantDouble(value=-78.52958190070723)), right=ConstantInt(value=70))), value=ReadIntegral(indexExpression=ReadSavedInt))))),
                GroundedActivity(Instant.parse("2025-01-02T03:41:20.235635Z"), Name("445471211820"), BlockActivity(statements=listOf(ToggleSwitch(index=ReadCounter(indexExpression=ConstantInt(value=-27)))))),
                GroundedActivity(Instant.parse("2025-01-02T04:07:39.728694Z"), Name("296744037140"), BlockActivity(statements=listOf(SaveBoolean(expression=CompareInt(left=AddInts(left=ReadCounter(indexExpression=ConstantInt(value=-46)), right=SubtractInts(left=IntFromDouble(doubleExpression=AddDoubles(left=SubtractDoubles(left=SubtractDoubles(left=ConstantDouble(value=-20.081075196544717), right=ReadSavedDouble), right=SubtractDoubles(left=ConstantDouble(value=-69.5766476943823), right=ConstantDouble(value=92.00419361926095))), right=ReadSavedDouble)), right=ReadCounter(indexExpression=IntFromDouble(doubleExpression=ReadIntegral(indexExpression=ReadSavedInt))))), right=IntFromDouble(doubleExpression=ConstantDouble(value=-73.34076401136508))))))),
                GroundedActivity(Instant.parse("2025-01-02T03:06:05.231838Z"), Name("170230978116"), BlockActivity(statements=listOf(Await(condition=Switch(indexExpression=IntFromDouble(doubleExpression=SubtractDoubles(left=ConstantDouble(value=-85.70909151094965), right=ConstantDouble(value=-12.211252192377174))))), IncreaseSlope(index=ConstantInt(value=3), amount=SubtractDoubles(left=ConstantDouble(value=20.652069993433514), right=AddDoubles(left=ConstantDouble(value=10.177933162410696), right=DoubleFromInt(intExpression=ReadSavedInt))))))),
            )
        )
        tester.move(GroundedActivity(Instant.parse("2025-01-02T03:41:20.235635Z"), Name("445471211820"), BlockActivity(statements=listOf(ToggleSwitch(index=ReadCounter(indexExpression=ConstantInt(value=-27)))))) to Instant.parse("2025-01-02T03:40:14.549194Z"))
    }
