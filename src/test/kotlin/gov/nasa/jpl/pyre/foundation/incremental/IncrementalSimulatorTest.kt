    ...
    fun `repro directly`() {
        ...
        val tester = test(::BlockTestModel,
            ...
            activities = listOf(
                ...
                GroundedActivity(Instant.parse("2025-01-02T21:35:21.234466Z"), Name("784073460995"), BlockActivity(listOf(
                    Spawn(listOf(
                        Spawn(listOf(
                            IncrementCounter(
                                IntFromDouble(ReadIntegral(ConstantInt(0))),
                                ConstantInt(value = 87)
                            ),
                            SetCounter(
                                index = ReadCounter(ConstantInt(2)),
                                value = ReadCounter(ConstantInt(53))
                            ),
                        )),
                            Await(ConstantBooleanResource(CompareInt(
                                left = ConstantInt(63),
                                right = IntFromDouble(ReadIntegral(ConstantInt(2))),
                            ))),
